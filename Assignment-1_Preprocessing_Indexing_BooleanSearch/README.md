...
Refer [scripts/README.md](../scripts/RUNTIME_INSTRUCTIONS) for build, run, and test instructions; And [docs/PA1_WRITEUP.md](docs/PA1_WRITEUP.md) for the methodology, repository structure,
